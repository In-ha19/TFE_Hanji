...
namespace Gestionnaire_Collections.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                // Trouver l'utilisateur par l'email encodé
                ...
                {
                    ModelState.AddModelError(string.Empty, "L'adresse mail n'est pas confirmée.");
                    return Page();
                }

                // Utiliser PasswordSignInAsync avec le UserName correspondant à l'email
